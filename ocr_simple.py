...
# 2. 初始化 PaddleOCR
print("第2步: 初始化 PaddleOCR...")
ocr = PaddleOCR(lang='ch', use_textline_orientation=True, det_model_dir=None, rec_model_dir=None)
print()
